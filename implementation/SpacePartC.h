...

{
    ...
    public:
        ...
        MailServerPartC & getserver(){return LocalServer;}

 

    SpacePartC(MailServerPartC &something): LocalServer(something)
...

{
    ...
    cout<<"Enter full name : "; getline(cin,str);
...

    {
        ...
        cout<<"Invalid password, try again : ";cin>>password;
...
void MakeUsers(User ** users,int Size,SpacePartC & MySpace)
...
void WriteMessages(User ** users,int Size,SpacePartC & MySpace)
